      ...
      <main>
        <div className="flex flex-col bg-white">
          ...
          <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
            <img src="/images/velas/vela-tensada.jpg" alt="Vela de sombra tensada en jardín" className="absolute inset-0 w-full h-full object-cover" />
                ...
                {shapes.map((s, i) => (
                  <FadeIn key={s.title} delay={i * 0.1}>
                    <div className="bg-white rounded-2xl overflow-hidden h-full border-t-[3px] border-terracotta shadow-sm hover:shadow-md transition-shadow duration-300 text-center">
                      <img src={s.image} alt={s.title} loading="lazy" decoding="async" className="w-full aspect-[16/10] object-cover" />
                      <div className="p-8">
